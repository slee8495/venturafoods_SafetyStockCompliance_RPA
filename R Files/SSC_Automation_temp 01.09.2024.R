...
load("C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_01_02_2024.rds")
...
inventory_model <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/SS Optimization by Location - Finished Goods December 2023 Modeling LL.xlsx",
...
Planner_address <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Address Book - 2024.01.02.xlsx", 
...
JD_item_branch <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.09.2024/Item_Branch.xlsx",
                             col_names = FALSE)
...
custord <- read.csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/DSXIE/2024/01.09/open_cust_ord.csv",
                    header = FALSE)
...
wo <- read.csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/DSXIE/2024/01.09/wo.csv",
               header = FALSE)
...
# New JDOH File ----
JDOH <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.09.2024/inv_bal.xlsx")
...
# https://edgeanalytics.venturafoods.com/MicroStrategyLibrary/app/DF007F1C11E9B3099BB30080EF7513D2/42F02D5F9B4254B7EE182F8D5A7BE289

# (Path revision needed) Change directory (MicroStrategy Inventory Analysis from Cassandra) ----
Inv_cassandra_fg <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.09.2024/Inventory Report for all locations (FG).xlsx",
                               col_names = FALSE)

Inv_cassandra_rm <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.09.2024/Inventory Report for all locations (RM).xlsx",
                               col_names = FALSE)
...
Inv_all %>%
  dplyr::filter(Location == 226) -> Inv_all_86_226_381
...
# Add Location 430
loc_430_for_jdoh <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.09.2024/3pl Bham Inventory week of 1-08-24.xlsx")
...
pre_ss_metrics <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.02.2024/SS Metrics 0102.xlsx")
...
iqr_fg <- readxl::read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/01.02.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.02.2024.xlsx",
                             sheet = "Location FG")
...
writexl::write_xlsx(ssmetrics_final_2, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.09.2024/SS Metrics 0109.xlsx") 
...
save(ssmetrics_mainboard, file = "C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_01_09_2024.rds")
