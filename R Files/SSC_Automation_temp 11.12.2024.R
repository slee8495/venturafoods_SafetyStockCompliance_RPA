...
load("C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_11_05_2024.rds")
...
custord <- read.xlsx("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/11122024/US and CAN OO BT where status _ J.xlsx",
                     colNames = FALSE)
...
wo <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/11122024/Open Work Order for 28 days.xlsx")
...
receipt <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/11122024/BT open order and qty.xlsx")
...
po <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/11122024/PO_JDE.xlsx",
                 sheet = "Daily Open PO")
...
JDOH_complete <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.11.12.xlsx",
                            sheet = "FG")
JDOH_complete_2 <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.11.12.xlsx",
                              sheet = "RM")
...
# Add Location 430
loc_430_for_jdoh <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/11122024/430.xlsx")
...
## Bring over Inv_Bal ##
inv_bal <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/11122024/inv_bal.xlsx")
inv_bal[-1:-2, ] -> inv_bal
...
pre_ss_metrics <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/11052024/SS Metrics 1105.xlsx")
...
iqr_fg <- readxl::read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/11.05.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 11.05.2024.xlsx",
                             sheet = "Location FG")
...
writexl::write_xlsx(ssmetrics_final_2, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/11.12.2024/SS Metrics 1112.xlsx") 
...
save(ssmetrics_mainboard, file = "C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_11_12_2024.rds")
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/11.05.2024/Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 11.05.2024.xlsb",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/11.12.2024/Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 11.12.2024.xlsb")
