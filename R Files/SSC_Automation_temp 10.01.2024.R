...
load("C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_09_24_2024.rds")
...
custord <- read.xlsx("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/09242024/US and CAN OO BT where status _ J.xlsx",
                     colNames = FALSE)
...
wo <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/10012024/WO_MSTR.xlsx")
...
receipt <- read.csv("S:/Supply Chain Projects/Data Source (SCE)/DSXIE/2024/10.01/receipt.csv",
                    header = FALSE)
...
po <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/10012024/PO_JDE.xlsx",
                 sheet = "Daily Open PO")
...
JDOH_complete <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.10.01.xlsx",
                            sheet = "FG")
JDOH_complete_2 <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.10.01.xlsx",
                              sheet = "RM")
...
# Add Location 430
loc_430_for_jdoh <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/10012024/430.xlsx")
...
## Bring over Inv_Bal ##
inv_bal <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/10012024/inv_bal.xlsx")
inv_bal[-1:-2, ] -> inv_bal
...
pre_ss_metrics <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/09242024/SS Metrics 0924.xlsx")
...
iqr_fg <- readxl::read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/09.24.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 09.24.2024.xlsx",
                             sheet = "Location FG")
...
writexl::write_xlsx(ssmetrics_final_2, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/10.01.2024/SS Metrics 1001.xlsx") 
...
save(ssmetrics_mainboard, file = "C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_10_01_2024.rds")
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/09.24.2024/Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 09.24.2024.xlsb",
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/10.01.2024/Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 10.01.2024.xlsb")
