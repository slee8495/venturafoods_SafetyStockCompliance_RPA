...
load("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/SS Compliance/Safety stock compliance/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_04_02_2024.rds")
...
JD_item_branch <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/SS Compliance/raw data/Item_Branch.xlsx",
                             col_names = FALSE)
...
## Bring over Inv_Bal ##
inv_bal <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/SS Compliance/raw data/inv_bal.xlsx")
inv_bal[-1:-2, ] -> inv_bal
...
iqr_fg <- readxl::read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 04.02.2024.xlsx",
                             sheet = "Location FG")
...
writexl::write_xlsx(ssmetrics_final_2, "C:/Users/lliang/OneDrive - Ventura Foods/R Studio/SS Compliance/Safety stock compliance/SS Metrics 0409.xlsx") 
...
save(ssmetrics_mainboard, file = "C:/Users/lliang/OneDrive - Ventura Foods/R Studio/SS Compliance/Safety stock compliance/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_04_09_2024.rds")
