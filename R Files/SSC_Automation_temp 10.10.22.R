...
load("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/SS Compliance/Safety stock compliance/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_9_26_22.rds")
...
ssmetrics_pre <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/SS Compliance/Archive/Copy of Safety Stock Compliance Report Data v3 - 09.26.22.xlsx",
                            col_names = FALSE)
...
exception_report <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/exception report 10.10.22.xlsx", 
                               sheet = "Sheet1")
...
custord <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 10.10.22.xlsx", 
...
wo <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 10.10.22.xlsx", 
...
receipt <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 10.10.22.xlsx", 
...
po <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 10.10.22.xlsx", 
...
# New JDOH File ----
JDOH <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inv Bal without Lot Number - 10.10.22.xlsx")
...
Inv_cassandra_fg <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Analysis - 10.10.22.xlsx",
                               sheet = "FG", col_names = FALSE)

Inv_cassandra_rm <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Analysis - 10.10.22.xlsx",
                               sheet = "RM", col_names = FALSE)
...
writexl::write_xlsx(ssmetrics_final_2, "SS Metrics 1010.xlsx") 
...
# (Path revision needed) ----
save(ssmetrics_mainboard, file = "ssmetrics_mainboard_10_10_22.rds")
