...
ssmetrics_pre <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/SS Compliance/Copy of Safety Stock Compliance Report Data v3 - 06.12.23.xlsx",
                            col_names = FALSE)
...
# New JDOH File ----
JDOH <- read_xlsx("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/ATT92129.xlsx")
...
Inv_cassandra_fg <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Analysis FG - 06.19.23.xlsx",
                               col_names = FALSE)

Inv_cassandra_rm <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Analysis RM - 06.19.23.xlsx",
                               col_names = FALSE)
...
# Add Location 430
loc_430_for_jdoh <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/3PL Inventory Week of 6-19-23 Bham.xlsx")
...
completed_sku_list <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Completed SKU list - Linda (16).xlsx")
...
writexl::write_xlsx(ssmetrics_final_2, "SS Metrics 0619.xlsx") 
...
# (Path revision needed) ----
save(ssmetrics_mainboard, file = "ssmetrics_mainboard_06_19_23.rds")
