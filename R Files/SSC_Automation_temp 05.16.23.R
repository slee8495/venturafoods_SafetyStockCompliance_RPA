...
load("C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_05_09_23.rds")
...
inventory_model <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/5.16.23/SS Optimization by Location - Finished Goods May 2023.xlsx",
...
ssmetrics_pre <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/SS Compliance/Copy of Safety Stock Compliance Report Data v3 - 05.09.23.xlsx",
                            col_names = FALSE)
...
Planner_address <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Address Book - 05.03.23.xlsx", 
...
JD_item_branch <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/5.16.23/Item Branch.xlsx",
                             col_names = FALSE)
...
exception_report <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/5.16.23/exception report.xlsx", 
                               sheet = "Sheet1")
...
# New JDOH File ----
JDOH <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/5.16.23/Inv Bal Without Lot Number.xlsx")
...
Inv_cassandra_fg <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/5.16.23/Inventory Analysis (70).xlsx",
                               col_names = FALSE)

Inv_cassandra_rm <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/5.16.23/Inventory Analysis (71).xlsx",
                               col_names = FALSE)
...
writexl::write_xlsx(ssmetrics_final_2, "SS Metrics 0516.xlsx") 
...
# (Path revision needed) ----
save(ssmetrics_mainboard, file = "ssmetrics_mainboard_05_09_23.rds")
