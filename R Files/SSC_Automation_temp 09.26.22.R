...
ssmetrics_pre <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/SS Compliance/Archive/Copy of Safety Stock Compliance Report Data v3 - 09.19.22.xlsx",
                            col_names = FALSE)
...
# New JDOH File ----
JDOH <- read_csv("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inv Balance without Lot Number - 09.26.22.csv")
