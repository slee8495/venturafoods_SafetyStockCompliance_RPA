...
load("C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_01_23_2024.rds")
...
JD_item_branch <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.30.2024/Item_Branch.xlsx",
                             col_names = FALSE)
...
custord <- read.csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/DSXIE/2024/01.30/open_cust_ord.csv",
                    header = FALSE)
...
wo <- read.csv("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/DSXIE/2024/01.30/wo.csv",
               header = FALSE)
...
# New JDOH File ----
JDOH <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.30.2024/inv_bal.xlsx")
...
Inv_cassandra_fg <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.30.2024/Inventory Report for all locations (FG).xlsx",
                               col_names = FALSE)

Inv_cassandra_rm <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.30.2024/Inventory Report for all locations (RM).xlsx",
                               col_names = FALSE)
...
# Add Location 430
loc_430_for_jdoh <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.30.2024/3pl Bham Inventory week of 1-29-24.xlsx")
...
pre_ss_metrics <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.23.2024/SS Metrics 0123.xlsx")
...
iqr_fg <- readxl::read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/01.23.2024/Finished Goods Inventory Health Adjusted Forward (IQR) NEW TEMPLATE - 01.23.2024.xlsx",
                             sheet = "Location FG")
...
####### 01/16/2024 #######
ssmetrics_final_2 %>% 
  dplyr::mutate(campus_no = ifelse(Location == "430", 43, campus_no),
                Campus = ifelse(Location == "430", "BHM", Campus)) %>% 
  dplyr::mutate(campus_ref = paste0(campus_no, "_", Item)) -> ssmetrics_final_2
...
writexl::write_xlsx(ssmetrics_final_2, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/01.30.2024/SS Metrics 0130.xlsx") 
...
save(ssmetrics_mainboard, file = "C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Safety_Stock_Compliance/RPA/venturafoods_SafetyStockCompliance_RPA/rds files/ssmetrics_mainboard_01_30_2024.rds")
